...
namespace WSH.WinForm.Controls
{
    ...
    */
    [ToolboxBitmap(typeof(LoadMask))]
    public class LoadMask : System.Windows.Forms.Control
    {
        private bool _transparentBG = true;//是否使用透明
        private int _alpha = 125;//设置透明度
        private Color backcolor = ColorTranslator.FromHtml("#333333");
        ...
        public LoadMask(int Alpha, bool IsShowLoadingImage)
        {
            ...
            if (IsShowLoadingImage)
            {
                ...
                pictureBox_Loading.Image = WSH.WinForm.Controls.Properties.Resources.loading;  
        ...
        protected override void OnPaint(System.Windows.Forms.PaintEventArgs e)
        {
            ...
            if (_transparentBG)
            {
                Color drawColor = Color.FromArgb(this._alpha, backcolor);
         ...
         */
        [Category("LoadMask"), Description("是否使用透明,默认为True")]
        ...
        [Category("LoadMask"), Description("设置透明度")]
        public int Alpha
        {
            get
            {
