...
namespace WSH.Windows.Common
{
    public class SystemFileHelper
    {
        ...
        /// 获取文件图标
        /// </summary>
        /// <param name="filePath">文件路径以及名称(文件全路径)</param>
        /// <returns>返回一个Icon类型的图标对象</returns>
        public static Icon GetFileExtractAssociatedIcon(string filePath)
        {
        ...
        /// 获取指定文件类型的描述         
        /// </summary>         
        /// <param name="fileName">文件扩展名或文件名</param>         
