...
namespace WSH.DataAccess.Dapper
{
    ...
    public class SqlQuery<T> : SqlQuery where T : class
    {
        ...
        /// </summary>
        /// <returns></returns>
        public static SqlQuery<T> Builder(DapperDb db)
        {
        ...
        /// <returns></returns>
        public SqlQuery<T> AndWhere(Expression<Func<T, object>> expr, FilterExpression operation, object value)
        {
        ...
        /// <param name="value"></param>
        /// <returns></returns>
        public SqlQuery<T> OrWhere(Expression<Func<T, object>> expr, FilterExpression operation, object value)
        {
        ...
        /// <param name="isAnd">true为AND false为OR</param>
        /// <returns></returns>
        private SqlQuery<T> Where(Expression<Func<T, object>> expr, FilterExpression operation, object value, bool isAnd)
        {
            var cn = isAnd ? "AND" : "OR";
            var field = Common.GetPropertyByExpress<T>(this._ModelDes,expr).Column;
        ...
        /// <returns></returns>
        private string GetOpStr(FilterExpression method)
        {
            switch (method)
            {
        ...
        /// <param name="value"></param>
        /// <returns></returns>
        private object CreateParam(FilterExpression method, object value)
        {
            switch (method)
            {
                case FilterExpression.Contains:
        ...
        /// <param name="value"></param>
        /// <returns></returns>
        private DynamicPropertyModel AddParam(FilterExpression method, string field, object value)
        {
            if (this._Param == null)
            {
                this._Param = new List<DynamicPropertyModel>();
