...
{
    #region 测试例子
    //FtpClient ftp = new FtpClient("127.0.0.1", "abc", "123456");
    ...
    public class FtpClient
    {
        ...
        public bool OpenUpload(Stream stream, string remote_filename)
        {
            return OpenUpload(stream, remote_filename, false);
        }
        /// <summary>
        /// 上传指定的文件
        /// </summary>
        ...
        /// <param name="remote_filename">远程要覆盖的文件名</param>
        /// <param name="resume">如果存在,则尝试恢复</param>
        public bool OpenUpload(Stream stream, string remote_filename, bool resume)
        {
            Connect();
            SetBinaryMode(true);
            OpenDataSocket();
