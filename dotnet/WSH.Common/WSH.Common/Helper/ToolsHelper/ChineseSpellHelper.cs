...
namespace WSH.Common.Helper
{
    public class ChineseSpellHelper
    {
        ...
        /// <returns></returns>
        public static string GetChineseAllSpell(string hzString)
        {
            // 匹配中文字符
        ...
        public static string GetChineseSimpleSpell(string str)
        {
            string tempStr = "";
            foreach (char c in str)
            {
                ...
                {
                    tempStr += GetChineseSpellChar(c.ToString());
                }
            }
            return tempStr;
        }
        ...
        public static string GetChineseSpellChar(string c)
        {
            if (c == " ")
            {
                return "";
