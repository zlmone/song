...
{
    public class VerificationCode : IDisposable
    {
        #region 私有字段
        ...
        public Image CreateImage()
        {
            ...
            for (int i = 0; i < _Text.Length; i++)
            {
                ...
                mat.RotateAt(18 - _Rand.Next(25), new PointF(x, y), MatrixOrder.Append);
                g.Transform = mat;
            ...
            for (int i = 1; i < n; i++)
            {
                pen = new Pen(_GetBrush(_ForeColor), 1);
        ...
        private Color _BorderColor
        {
            get
            {
                ...
                return Color.FromArgb(_Rand.Next(60, 90), colors[_Rand.Next(0, colors.Length)]);
            }
        }
