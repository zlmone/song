    ...
    song.extend(song.control,song.grid,{
        ...
        init:function(){
            ...
            if(this.toolbar){
                ...
                this.tb=new song.toolbar({renderTo:this.dom.ttb,title:this.title || "列表",items:this.toolbar,border:"1px 1px 0px 1px"});
            }
            if(this.pagination){
                ...
                this.paging=new song.pagingToolbar({
                    ...
                    beforeLoad:function(){
                        if(me._beforeLoad()===false){return false;}
        ...
        _beforeLoad:function(){
            var me=this;
            if(me.beforeLoad){
                if(me.beforeLoad.call(me)===false){return false;}
            }
            me._showMask();
            return true;
        },
...
//            });
        ...
        hide:function(){
            this.dom.wrap.hide();return this;
        },
        show:function(){
            this.dom.wrap.show();return this;
        },
        _showMask:function(){
            if(this.loading){
        ...
        reStyle:function(){
            //重新设置表格行的样式
            this._initRow(false);return this;
        },
        _initColumns:function(cols){
            ...
            for (; i < len; i++) {
                ...
                //如果是复选框列
                if(col.checkbox){
                    this.isCheckColumn=true;col.resizable=false;col.sortable=false;
                    ...
                    //防止拖动列宽时事件冒泡
                    if(col.resizable){
                        inner.bind("mousedown",function(){return false;});
                    }
                    //是否开启列头排序
                    if(col.sortable){
                    ...
                    if(col.resizable){
                        ...
                        new song.resize(td,{
                            ...
                            onStart:function(e){
                                ...
                                if(me.height=="auto"){
                                    me.dom.separator.css({height:me.dom.header.outerHeight()+me.dom.body.outerHeight(),zIndex:song.zIndex(),top:me._getToolbarHeight()});                
                                }
        ...
        setSelectedRow:function(row_index){
            this.clearSelection().selectRow(row_index,true,true);return this;
        },
        ...
        clearSelection:function(){
            if(this.selectionMode=="single"){
                ...
                var i=0,rows=this._rows;len=this._rows.length;
                for (; i < len; i++) {
        ...
        addRow:function(data){
            ...
            this._createRow(data,this._rows.length);return this;
        },
...
//            }
        ...
        _getDom:function(){
            ...
            if(this.readOnly){
                wrap.addClass("noselect").bind("selectstart",function(){return false;});
            }
