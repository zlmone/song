...
;(function (song, j) {
    ...
    song.extend(song.control, song.toolbar, {
        ...
        destroy: function () {
            this.wrap = this.table = this._items = this.title = null;
            this.renderTo = null;
        }
    });
    //***********************************pagingToolbar***********************************
    ...
    song.extend(song.toolbar, song.pagingToolbar, {
        ...
        loaded: function () {
            ...
            ;
            this.firstBtn = this.addButton({
                iconClass: "icon-first", onClick: function () {
                    me.moveFirst();
                }
            });
            this.prevBtn = this.addButton({
                iconClass: "icon-prev", onClick: function () {
                    me.movePrev();
                }
            });
            this.add("-", "&nbsp;第");
            ...
            this.nextBtn = this.addButton({
                iconClass: "icon-next", onClick: function () {
                    me.moveNext();
                }
            });
            this.lastBtn = this.addButton({
                iconClass: "icon-last", onClick: function () {
                    me.moveLast();
                }
            });
            if (!this.simple) {
                this.add("-");
                this.reloadBtn = this.addButton({
                    iconClass: "icon-reload", onClick: function () {
                        me.load();
                    }
                });
